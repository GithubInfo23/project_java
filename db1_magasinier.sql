...
CREATE TABLE `magasinier` (
  `id_magasinier` int NOT NULL AUTO_INCREMENT,
  `choix_service` varchar(255) DEFAULT NULL,
  `date` date DEFAULT NULL,
  `id_utilisateur` int NOT NULL,
  PRIMARY KEY (`id_magasinier`),
  KEY `id8_idx` (`id_utilisateur`),
  CONSTRAINT `id8` FOREIGN KEY (`id_utilisateur`) REFERENCES `utilisateur` (`id_utilisateur`)
...
INSERT INTO `magasinier` VALUES (5,NULL,NULL,7);
