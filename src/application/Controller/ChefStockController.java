...
//			
	...
	public void ouvrirEntrepot(ActionEvent event) throws IOException {
		...
		try{
					loadScene( event ,"/project_java/src/application/View/Entropot.fxml");
			}
	...
	public void ouvrirAjoutProduit(ActionEvent event) throws IOException {
		...
		try{
					...
					loadScene( event ,"/project_java/src/application/View/ProduitAjout.fxml");
	...
	public void ouvrirListProduit(ActionEvent event) throws IOException {
		...
		try{
					loadScene( event ,"/project_java/src/application/View/ProduitListe.fxml");
	...
	public void ouvrirAjoutStock(ActionEvent event) throws IOException {
		...
		try{
					...
					loadScene( event ,"/project_java/src/application/View/StockAjout.fxml");
